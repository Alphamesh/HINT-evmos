...
import (
	...
	"github.com/evmos/evmos/v10/testutil/sample"
	coinsimulation "github.com/evmos/evmos/v10/x/coin/simulation"
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	coinGenesis := types.GenesisState{
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeposit,
		coinsimulation.SimulateMsgDeposit(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgWithdraw,
		coinsimulation.SimulateMsgWithdraw(am.accountKeeper, am.bankKeeper, am.keeper),
	))
